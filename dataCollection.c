...
void writeToWHeader(){
    fprintf(fInUse, "ToW_time F_ToW[0] F_ToW[1] F2_ToW[0] F2_ToW[1] FMT_ToW[0] FMT_ToW[1] F2MT_ToW[0] F2MT_ToW[1] FH_ToW[0] FH_ToW[1] F2H_ToW[0] F2H_ToW[1] Fteam_ToW[0] Fteam_ToW[1] FonMT_ToW[0][0] FonMT_ToW[0][1] FonMT_ToW[1][0] FonMT_ToW[1][1] FonOT_ToW[0] FonOT_ToW[1] n_ToW[0] n_ToW[1]");
}
...
void writeToW(){
    fprintf(fInUse, "%-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E %-+23.16E",
