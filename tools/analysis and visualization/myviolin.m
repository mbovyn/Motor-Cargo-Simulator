% Edited by Matt Bovyn to include input of support type
...
if isempty(find(strcmp(varargin,'Support')))==0
    support_value = varargin{find(strcmp(varargin,'Support'))+1};
else
...
for i=1:size(Y,2)
    ...
    if isempty(b)==0
        [f, u, bb]=ksdensity(Y{i},'bandwidth',b(i),'Support',support_value);
    elseif isempty(b)
