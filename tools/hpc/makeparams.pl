...
N      30 0 //number of motors

//Muller Sim
F_s    5 5 //stall force (pN) 5
F_d    4 4 //detachment force (pN) 4
eps_0  .7 1 //base unbinding rate (1/sec) 1
...
multiMT_assay 1             //1 for switch, 2 for ToW
StopOnBeadDissociation 0    //stop if bead is > 500nm from all MTs
