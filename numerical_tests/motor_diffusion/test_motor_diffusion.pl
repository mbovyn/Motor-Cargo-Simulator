...
our $run_name = "test_motor_diffusion";
...
our @sweepvars = ("D_m1","SB");
our @sweepvals = (
   [.01,.1, 1, 10],
   [-1.221730476396031,-0.872664625997165,-0.523598775598299,-0.174532925199433,0.174532925199433,0.523598775598299,0.872664625997165,1.221730476396031]
   );
#print "\n@{$sweepvals[0]}\n";
#print "\n@{$sweepvals[1]}\n";
...
our $StopBelowThetaC=1; our $SB=-1; our $cc40="//2nd value elevation radians -pi/2 to pi/2";
