...
our $run_name = "radial_force_test";
...
our $N1=4;      our $N2=1;         our $cc1="//number of motors";
...
our $ExternalForce=2; our $EFx=-3; our $EFy=0; our $EFz=0;
our $cc29="/*
...
our $StopOnTime=.0005;                 our $cc38="//0 for don’t stop, otherwise enter time (s)";
