...
our $ReturnDetails=4; our $RD2=1; our $RD3=0; our $RD4=1; our $RD5=1;
...
our $StopOnTime=.0001;                 our $cc38="//0 for don’t stop, otherwise enter time (s)";
