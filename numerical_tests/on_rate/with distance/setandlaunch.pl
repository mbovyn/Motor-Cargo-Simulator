...
our $run_name = "on_rate_dist_test";
...
our @sweepvars = ("cz");
our @sweepvals = (
   [.25,.27,.29,.31,.33,.332,.334,.336,.338,.34],
   #[.25,.27,.29,.31,.33],
   );
#print "\n@{$sweepvals[0]}\n";
#print "\n@{$sweepvals[1]}\n";
...
our $InitialLocations=4; our $IL2=0; our $IL3=0;
our $cc19="/*
1:
...
our $StopOnAllAttached=1;           our $cc36="//Stop when all motors bound";
...
# //debugging
our $dt_override=100; our $cc45="//Value in (s). \"inf\"=ignore dt_default. 0=no override. (-) ignore checks";
